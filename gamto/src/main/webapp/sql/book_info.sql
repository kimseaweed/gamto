...
create table book_info(
    b_code VARCHAR2(20) PRIMARY KEY, --책 코드번호   
...
--데이터 입력
insert into book_info values('ISBN0001', '사피엔스', '유발 하라리', '김영사', '2023.04.01', 'ISBN0001.jpeg', 
'인문학', 20000, 500, '인류에 대해 분석하다', 0);
insert into book_info values('ISBN0002', '종의 기기원', '정유정', '은행나', '2016.05.16', 'ISBN0002.jpeg', 
'소설', 20000, 500, '사이코패스의 살인 이야', 0);
--데이터 찾기무
